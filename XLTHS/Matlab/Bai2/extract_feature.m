...
function feature_vector = extract_feature(v, N_FFT, Mframe_ondinh, frame_shilft)
    ...
    fft_results = get_fft_result(frames_windowed, N_FFT);
    % Đảm bảo Mframe_ondinh nằm trong phạm vi hợp lệ
